/*
*	MAIN JS FILE for Wordwise Ghost Theme
*
...
// MOBILE MENU
// ===============================
var menuIcon = document.getElementById('mobile-menu-ignite-wwise');
var menuList = document.querySelector('#main-nav-wwise ul');
